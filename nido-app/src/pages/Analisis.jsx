    ...
    <div className="max-w-7xl mx-auto space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
        ...
        <div className="md:col-span-12 bg-surface-container-lowest/40 backdrop-blur-md p-6 sm:p-8 rounded-[2rem] border border-outline-variant/60 shadow-lg overflow-hidden mt-2">
          <h3 className="font-headline font-bold text-on-surface mb-6 text-xl">Movimientos Atípicos</h3>
            ...
            <table className="w-full text-left border-collapse">
              <thead className="text-[11px] font-black text-on-surface-variant uppercase border-b border-outline-variant">
                <tr>
                  ...
                  <th className="pb-4 font-medium tracking-wider">Estado</th>
                  <th className="pb-4 font-medium tracking-wider text-right">Acción</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-outline-variant/50">
                <tr className="hover:bg-surface-container-lowest transition-colors group">
                  <td className="py-4 flex items-center gap-3">
                    ...
                    <span className="font-bold text-on-surface">Supermercado El Sol</span>
                  </td>
                  <td className="py-4 text-sm font-medium text-on-surface-variant">14 Oct, 2023</td>
                  <td className="py-4 text-sm font-black text-on-surface">$245.00</td>
                  <td className="py-4">
                    <span className="px-3 py-1 rounded-full bg-error-container text-error text-[10px] font-black uppercase tracking-wider">+25% promedio</span>
                  </td>
                  <td className="py-4 text-right">
                    <button className="text-primary hover:text-primary/80 text-sm font-bold transition-colors">Revisar ticket</button>
                  </td>
                </tr>
                <tr className="hover:bg-surface-container-lowest transition-colors group">
                  <td className="py-4 flex items-center gap-3">
                    ...
                    <span className="font-bold text-on-surface">Gasolinera Centro</span>
                  </td>
                  <td className="py-4 text-sm font-medium text-on-surface-variant">12 Oct, 2023</td>
                  <td className="py-4 text-sm font-black text-on-surface">$60.00</td>
                  <td className="py-4">
                    <span className="px-3 py-1 rounded-full bg-primary-container text-primary text-[10px] font-black uppercase tracking-wider">En presupuesto</span>
                  </td>
                  <td className="py-4 text-right">
                    <button className="text-primary hover:text-primary/80 text-sm font-bold transition-colors">Revisar ticket</button>
                  </td>
